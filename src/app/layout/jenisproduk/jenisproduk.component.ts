...
@Component({
    selector: 'app-produk-tabungan',
    templateUrl: './jenisproduk.component.html',
    styleUrls: ['./jenisproduk.component.scss'],
...
export class JenisprodukComponent implements OnInit {
    ...
    tambah(event, acc, bunga, pajak, setawal, setminimal, mintarik, maxtarik, biayaoffrek, salmin, 
        ...
        this._http.post('http://103.15.226.134:2017/tabungan/produk/add', body).map(res => res.json())
            .subscribe(data => {
    ...
    update(event, acc, bunga, pajak, setawal, setminimal, mintarik, maxtarik, biayaoffrek, salmin, 
        ...
        this._http.post('http://103.15.226.134:2017/tabungan/produk/update', body).map(res => res.json())
            .subscribe(data => {
                // this.identitas = data['data'];
                this.msg = data['msg'];
                if (this.msg == true) {
    ...
    delete() {
        ...
        this._http.post('http://103.15.226.134:2017/tabungan/produk/delete', body).map(res => res.json())
        .subscribe(data => {
            // this.identitas = data['data'];
